...
class AllSubscriptionPage extends StatefulWidget {
  const AllSubscriptionPage({super.key});

  @override
  State<AllSubscriptionPage> createState() => _AllSubscriptionPageState();
}

class _AllSubscriptionPageState extends State<AllSubscriptionPage> {
        ...
        return Column(
          ...
          children: [
            Padding(
              ...
              child: TextBold(
                str: 'All Subscription (${data?.length})'.toUpperCase(),
                size: 14,
  ...
  void getAllSubscriptionAPI() {
    _commonBloc.getAllSubscriptionAPI();
  }
  ...
  void setObservables() {
    _commonBloc.apiResponse.listen((map) {
      ...
      switch (apiType) {
        case ApiType.ALL_SUBSCRIPTION_LIST:
          {
